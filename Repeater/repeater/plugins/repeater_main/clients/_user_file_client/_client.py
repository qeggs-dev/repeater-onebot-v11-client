...
class UserFileClient(BaseClient):
    ...
    async def get_user_data_file_url(self):
        ...
        return urljoin(self.base_url, f"{DOWNLOAD_USER_DATA_FILE_ROUTE}/{self._persona_info.namespace_str}.zip")
    # endregion
    ...
    async def package_user_space_url(self):
        ...
        return urljoin(self.base_url, f"{PACKAGE_USER_SPACE_ROUTE}/{self._persona_info.namespace_str}.zip")